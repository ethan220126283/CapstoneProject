...
public class Librarian implements Serializable {
    ...
    public static class Builder {
        ...
        //Builder returns
        public Builder librarian_ID (int id) {
            this.id = id;
            return this;
        }

        public Builder librarian_Name (String name) {
            this.name = name;
            return this;
        }

        public Builder librarian_Address (String address) {
            this.address = address;
            return this;
        }

        public Builder librarian_Tel (String tel) {
            this.tel = tel;
            return this;
        }
